          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="contact-box">
                <i className="yellow-color fas fa-map-marker-alt" />
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="contact-box">
                <i className="yellow-color fas fa-phone-square" />
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="contact-box">
                <i className="yellow-color far fa-envelope-open" />
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="contact-box">
                <i className="yellow-color far fa-clock" />
